...
document.addEventListener('click', function(e) {
    if (e.target && e.target.classList.contains('project-details-btn')) {
            ...
            projects: `
                <div class="project-list">
                    <div class="project-item">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj1">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj2">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj3">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj4">Details</button>
                    </div>
                </div>
            `,
            achievements: `
            ...
            projects: `
                <div class="project-list">
                    <div class="project-item">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj5">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj6">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj7">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj8">Details</button>
                    </div>
                </div>
            `,
            achievements: `
            ...
            projects: `
                <div class="project-list">
                    <div class="project-item">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj9">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj10">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj11">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj12">Details</button>
                    </div>
                </div>
            `,
            achievements: `
            ...
            projects: `
                <div class="project-list">
                    <div class="project-item">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj13">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj14">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj15">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj16">Details</button>
                    </div>
                </div>
            `,
            achievements: `
            ...
            projects: `
                <div class="project-list">
                    <div class="project-item">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj17">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj18">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj19">Details</button>
                    </div>
                    <div class="project-item">
                        <div class="project-info">
                        ...
                        <button class="view-btn project-details-btn" data-id="proj20">Details</button>
                    </div>
                </div>
            `,
            achievements: `
